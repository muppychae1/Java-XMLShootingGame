...
public class BulletThread extends Thread {
	...
	public BulletThread(Block bulletBlock, Block playerBlock, GameInfoPanel gameInfoPanel, MainPanel gamePanel) {
		this.bulletBlock = bulletBlock;
			...
			while(true) {
				if(hitPlayer()) {
					...
					if(playerBlock.getLife() == 0) {
						gamePanel.resetGame();
						JOptionPane.showMessageDialog(null, "GAME OVER\n당신의 점수는 " + gameInfoPanel.getScore(),"Message", JOptionPane.INFORMATION_MESSAGE);
						System.exit(0);
					}
					return;
				}
