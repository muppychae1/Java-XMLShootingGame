...
public class BlockThread extends Thread{
	...
	// 공격력이 없는 BlockThread
	public BlockThread(Block [] blockList, BlockThread [] blockThreadList, Block block, int i, GameInfoPanel gameInfoPanel, MainPanel gamePanel) {
	...
	// 공격력이 있는 BlockThread
	public BlockThread(Block [] blockList, BlockThread [] blockThreadList, Block block, int i, GameInfoPanel gameInfoPanel, Node bulletNode, Block playerBlock, MainPanel gamePanel) {
		this.blockList = blockList;
		this.blockThreadList = blockThreadList;
		this.block = block;
		this.i = i;
...
//					ImageIcon bulletIcon = new ImageIcon(XMLReader.getAttr(bulletNode, "img"));
					ImageIcon bulletIcon = new ImageIcon("img/fireball.png");
					...
					BulletThread bulletThread = new BulletThread(bulletBlock, playerBlock, gameInfoPanel, gamePanel);
					bulletThread.start();
				...
				try {
					...
					if(block.getHit() <= 0) { // block의 목숨이 다 차감되었을 때
						gameInfoPanel.setScore(block.getScore());
						blockList[i] = null;
